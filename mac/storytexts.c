...
/* ステージ2 空室判定時文*/
extendstr talk_st2_null[HEIGHT - 2] = {
	{"ここにはなにもない▼  ",0,0},
};
...
extendstr talk_st4_6[HEIGHT - 2] = {
	{"住民１：「下からきて暴れてるやつがいるって？」▼ ",0,0},
	{"住民２：「大したことはないだろう。▼ ",0,0},
	{"強力な修復機能の開発に成功したと聞いているし。▼ ",10,0},
